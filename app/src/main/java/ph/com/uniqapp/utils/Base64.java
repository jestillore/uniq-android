...
public class Base64 {
	 ...
	 *            Specified options
	 * @return The Base64-encoded object
	 * @see ph.com.uniqapp.utils.Base64#GZIP
	 * @see ph.com.uniqapp.utils.Base64#DO_BREAK_LINES
	 * @throws java.io.IOException
	 *             if there is an error
	 * @since 2.0
	 */
	...
	/**
	 * A {@link ph.com.uniqapp.utils.Base64.InputStream} will read data from another
	 * <tt>java.io.InputStream</tt>, given in the constructor, and encode/decode
	 * to/from Base64 notation on the fly.
	 * 
	 * @see ph.com.uniqapp.utils.Base64
	 * @since 1.3
	 */
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link ph.com.uniqapp.utils.Base64.InputStream} in DECODE mode.
		 * 
		 * @param in
		...
		/**
		 * Constructs a {@link ph.com.uniqapp.utils.Base64.InputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		 ...
		 * @param options
		 *            Specified options
		 * @see ph.com.uniqapp.utils.Base64#ENCODE
		 * @see ph.com.uniqapp.utils.Base64#DECODE
		 * @see ph.com.uniqapp.utils.Base64#DO_BREAK_LINES
		 * @since 2.0
		 */
	...
	/**
	 * A {@link ph.com.uniqapp.utils.Base64.OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link ph.com.uniqapp.utils.Base64.OutputStream} in ENCODE mode.
		 * 
		 * @param out
		...
		/**
		 * Constructs a {@link ph.com.uniqapp.utils.Base64.OutputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
